...
import { CopyRightText } from '../Constants/StaticText';
      ...
      <div className="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
        ...
        >
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className=" text-primary-700 dark:text-primary-dark-700 dark:text-gray-300"
          >
            <svg
              fill="currentColor"
              strokeLinecap="round"
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="ml-3  text-primary-700 dark:text-primary-dark-700 dark:text-gray-300"
          >
            <svg
              fill="currentColor"
              strokeLinecap="round"
